...
def get_best_feature_group(samples_train, results_train, samples_test, results_test, features):
    ...
    d = 0
    best_group = []
    for FG in get_combinations(features):
        if len(FG) == 0:
            continue
        temp_samples_train = samples_train[FG]
        temp_samples_test = samples_test[FG]
...
if __name__ == '__main__':
    ...
    res_in_words = get_best_feature_group(samples_train, results_train, samples_test, results_test, features)
